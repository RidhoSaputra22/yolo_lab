...
export default function App() {
    ...
    return (React.createElement(ToastProvider, null,
        React.createElement("div", { className: joinClasses(isLabelerRoute ? "flex h-screen flex-col overflow-hidden" : "min-h-screen", "bg-white text-base-content") },
            React.createElement("header", { className: joinClasses("z-30 border-b border-base-300/70 bg-base-100/85 backdrop-blur-xl", isLabelerRoute ? "shrink-0" : "sticky top-0") },
                React.createElement("div", { className: joinClasses("mx-auto flex w-full max-w-[1800px] px-4 lg:px-6", isLabelerRoute ? "items-center justify-between gap-4 py-3" : "flex-col gap-4 py-4") }, isLabelerRoute ? (React.createElement(React.Fragment, null,
                    React.createElement("div", { className: "min-w-0 space-y-2" },
                        ...
                        React.createElement("div", null,
                            ...
                            React.createElement("h1", { className: "mt-1 truncate text-xl font-bold tracking-tight text-slate-900" }, pageMeta.title))),
                    React.createElement("nav", { className: "flex flex-wrap justify-end gap-2" },
                        React.createElement(Button, { variant: route === "labeler" ? "primary" : "ghost", isSubmit: false, size: "sm", className: joinClasses("rounded-sm px-4", route !== "labeler" && "border border-base-300 bg-base-100"), onClick: () => navigate("labeler") }, "Manual Labeler"),
                        React.createElement(Button, { variant: route === "footage" ? "info" : "ghost", isSubmit: false, size: "sm", className: joinClasses("rounded-sm px-4", route !== "footage" && "border border-base-300 bg-base-100"), onClick: () => navigate("footage") }, "Footage Dataset"),
                        React.createElement(Button, { variant: route === "tester" ? "secondary" : "ghost", isSubmit: false, size: "sm", className: joinClasses("rounded-sm px-4", route !== "tester" && "border border-base-300 bg-base-100"), onClick: () => navigate("tester") }, "YOLO Tester"),
                        React.createElement(Button, { variant: route === "training" ? "warning" : "ghost", isSubmit: false, size: "sm", className: joinClasses("rounded-sm px-4", route !== "training" && "border border-base-300 bg-base-100"), onClick: () => navigate("training") }, "YOLO Training")))) : (React.createElement("div", { className: "flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between" },
