...
export function FootageCommandPanel({ preview, previewError, previewState, job, defaults, }) {
    ...
    return (React.createElement(Card, { className: "rounded-sm border border-base-300 bg-base-100/90 shadow-lg" },
        React.createElement("div", { className: "space-y-4" },
            ...
            previewError ? (React.createElement(Alert, { type: "error", className: "rounded-sm text-sm" }, previewError)) : null,
            ...
            React.createElement("div", { className: "grid gap-3 lg:grid-cols-2" },
                React.createElement("div", { className: "rounded-sm border border-base-300 bg-slate-950 p-4" },
