            ...
            React.createElement("div", { className: "space-y-4" },
                ...
                selectedFolder ? (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("div", { className: "grid gap-4" }, selectedFolder.runs.length ? (selectedFolder.runs.map((run) => (React.createElement("article", { key: run.key, className: "overflow-hidden rounded-sm border border-base-300 bg-base-100 shadow-md" },
                        run.video?.downloadUrl ? (React.createElement("div", { className: "border-b border-base-300 bg-slate-950" },
                            React.createElement("video", { className: "aspect-video w-full bg-slate-950", controls: true, preload: "metadata", src: run.video.downloadUrl }))) : (React.createElement("div", { className: "grid aspect-video place-items-center border-b border-base-300 bg-slate-950 px-4 text-center text-sm text-slate-400" }, "File video belum tersedia untuk run ini.")),
                        React.createElement("div", { className: "grid gap-4 p-5" },
                            ...
                            React.createElement("div", { className: "flex flex-wrap gap-2" },
                                React.createElement(Badge, { type: run.video ? "success" : "ghost", className: "px-3 py-3" }, run.video ? "Video" : "Tanpa video"),
