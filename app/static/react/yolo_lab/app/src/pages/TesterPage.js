...
export default function TesterPage() {
    ...
    const usesLocalEmployeeFaces = isVideoMode
    ...
    return (React.createElement("div", { className: "grid gap-4 pb-[160px] md:pb-[100px]" },
        React.createElement("section", { className: "yolo-toolbar flex flex-col gap-3 rounded-md border border-base-300 bg-base-100/90 p-4 shadow-lg xl:flex-row xl:items-center xl:justify-between" },
            React.createElement("div", { className: "flex flex-wrap items-center gap-3" },
                ...
                React.createElement("div", { className: "text-sm" },
                    React.createElement("span", { className: "font-semibold text-base-content" }, job?.outputDir || defaults.outputDir || "-"),
            ...
            React.createElement("div", { className: "flex flex-wrap items-center gap-2" },
                React.createElement(Button, { variant: "primary", isSubmit: false, size: "sm", className: "rounded-md px-5", disabled: Boolean(job?.running) || isConfigLoading, onClick: handleRun }, "\u25B6 Jalankan Test"),
        ...
        wantsEmployeeLabelingInVideo && formValues.faceRegistrySource === "backend" && (React.createElement(Alert, { type: "info", className: "rounded-md text-sm leading-6" }, "Tracking petugas pada video sedang memakai registry dari backend. Jika ingin memaksa pembanding wajah dari folder lokal `petugas`, ubah `Sumber data petugas` menjadi `Folder lokal petugas`.")),
