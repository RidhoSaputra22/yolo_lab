...
export function LabelerAutolabelModal({ open, onClose, activeFramesDir, images, visibleImages, totalImages, currentImageName, selectedImageNames, autolabelConfig, autolabelSuggestions, autolabelWarnings, job, onAutolabelConfigChange, onReplaceSelection, onSelectCurrentImage, onSelectVisibleImages, onSelectPendingImages, onClearSelection, onToggleImageSelection, onAutolabelCurrent, onAutolabelSelection, onAutolabelAll, }) {
    ...
    return (React.createElement("div", { className: "fixed inset-0 z-[70]" },
        ...
        React.createElement("div", { className: "relative flex h-full items-center justify-center p-3 md:p-6" },
            React.createElement("div", { className: "flex h-[min(92vh,980px)] w-[min(96vw,1540px)] flex-col overflow-hidden rounded-md border border-slate-200 bg-base-100 shadow-2xl", onClick: (event) => event.stopPropagation() },
                React.createElement("div", { className: "flex flex-wrap items-start justify-between gap-4 border-b border-base-300 px-5 py-4 md:px-6" },
                    ...
                    React.createElement(Button, { variant: "ghost", outline: true, isSubmit: false, className: "rounded-md", onClick: onClose }, "Tutup")),
                    ...
                    React.createElement("aside", { className: "min-h-0 overflow-y-auto border-b border-base-300 bg-base-100 xl:border-b-0 xl:border-r" },
                        React.createElement("div", { className: "space-y-4 p-5" },
                            React.createElement("div", { className: "grid gap-3 sm:grid-cols-2 xl:grid-cols-1" },
                                React.createElement("div", { className: "rounded-md border border-base-300 bg-base-200/30 p-4" },
                                    ...
                                    React.createElement("div", { className: "mt-4 grid gap-2" },
                                        React.createElement(Button, { variant: "warning", outline: true, isSubmit: false, className: "rounded-md justify-start", disabled: !currentImageName || !modelValue.trim() || isRunning, onClick: onAutolabelCurrent }, "Auto-label frame aktif"),
                                        React.createElement(Button, { variant: "warning", isSubmit: false, className: "rounded-md justify-start", disabled: !selectedCount || !modelValue.trim() || isRunning, onClick: onAutolabelSelection }, "Auto-label frame terpilih"),
                                        React.createElement(Button, { variant: "warning", outline: true, isSubmit: false, className: "rounded-md justify-start", disabled: !totalImages || !modelValue.trim() || isRunning, onClick: onAutolabelAll }, "Auto-label semua frame"))),
                                React.createElement("div", { className: "rounded-md border border-base-300 bg-base-200/40 p-3 text-sm" },
                            ...
                            React.createElement("div", { className: "rounded-md border border-base-300 bg-base-200/30 p-4" },
                                ...
                                React.createElement("div", { className: "mt-4 grid gap-4" },
                                    React.createElement("div", { className: "form-control w-full" },
                                        React.createElement("label", { className: "flex min-h-12 cursor-pointer items-center gap-3 rounded-md border border-base-300 bg-base-100/80 px-4 transition-colors hover:border-base-content/20" },
                            ...
                            isRunning ? (React.createElement(Alert, { type: "info", className: "rounded-md text-sm" }, "Auto-label sedang berjalan. Kamu masih bisa meninjau pilihan frame di panel kanan, tetapi proses berikutnya baru bisa dijalankan setelah job sekarang selesai.")) : null,
                            selectedCount > 0 && selectedExistingLabelCount > 0 ? (React.createElement(Alert, { type: "warning", className: "rounded-md text-sm" },
                                selectedExistingLabelCount,
                                " frame terpilih sudah punya label dan akan di-refresh saat menjalankan mode selection.")) : null,
                            autolabelWarnings.length ? (React.createElement(Alert, { type: "warning", className: "rounded-md text-sm" },
                            ...
                            React.createElement("div", { className: "border-b border-base-300 bg-base-100/80 px-5 py-4" },
                                React.createElement("div", { className: "flex flex-col gap-4" },
                                    React.createElement("div", { className: "flex flex-wrap gap-2" },
                                        React.createElement(Button, { variant: "ghost", outline: true, isSubmit: false, size: "sm", className: "rounded-md", disabled: !currentImageName, onClick: handleSelectCurrentImage }, "Pilih frame aktif"),
                                        React.createElement(Button, { variant: "ghost", outline: true, isSubmit: false, size: "sm", className: "rounded-md", disabled: !visibleImages.length, onClick: handleSelectVisibleImages }, "Pilih semua terlihat"),
                                        React.createElement(Button, { variant: "ghost", outline: true, isSubmit: false, size: "sm", className: "rounded-md", disabled: !pendingVisibleImages.length, onClick: handleSelectPendingImages }, "Pilih pending"),
                                        React.createElement(Button, { variant: "ghost", outline: true, isSubmit: false, size: "sm", className: "rounded-md", disabled: !selectedCount, onClick: handleClearVisibleSelection }, "Reset selection")),
                                ...
                                React.createElement("div", { ref: mainbarViewportRef, className: joinClasses("h-full min-h-0 overflow-y-auto p-5", dragSelectionRect ? "cursor-crosshair" : "") }, visibleImages.length ? (React.createElement(React.Fragment, null,
                                    React.createElement("div", { className: "grid select-none gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4", onMouseDown: handleGridMouseDown }, renderedVisibleImages.map((item) => {
                                        ...
                                        return (React.createElement("button", { key: item.name, "data-image-name": item.name, type: "button", "aria-pressed": isSelected, "aria-current": isCurrent ? "true" : undefined, onClick: (event) => handleImageCardClick(event, item.name), onDragStart: (event) => event.preventDefault(), ref: (node) => {
                                            ...
                                            }, className: joinClasses("group overflow-hidden rounded-md border bg-base-100 text-left transition duration-150 select-none", isSelected
                                    ...
                                    hasMoreVisibleImages ? (React.createElement("div", { className: "mt-5 flex justify-center" },
                                        React.createElement(Button, { variant: "ghost", outline: true, isSubmit: false, className: "rounded-md", onClick: () => setVisiblePreviewCount((current) => Math.min(current + FRAME_GRID_BATCH_SIZE, visibleImages.length)) },
                                            "Tampilkan ",
                                            Math.min(FRAME_GRID_BATCH_SIZE, visibleImages.length - visiblePreviewCount),
                                            " frame lagi"))) : null)) : (React.createElement(Alert, { type: "info", className: "rounded-md text-sm" }, "Tidak ada frame aktif yang cocok dengan filter dan pencarian saat ini."))),
                                dragSelectionRect ? (React.createElement("div", { className: "pointer-events-none absolute inset-0 z-20 overflow-hidden" },
                                    React.createElement("div", { className: "absolute rounded-md border-2 border-warning bg-warning/20 shadow-sm", style: {
