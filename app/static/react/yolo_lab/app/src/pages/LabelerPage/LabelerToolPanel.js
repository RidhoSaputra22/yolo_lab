        ...
        React.createElement(LabelerSidebarSection, { title: "Petunjuk", eyebrow: "Shortcut", description: "Ringkasan gesture dan shortcut yang paling sering dipakai saat labeling." },
            React.createElement("ul", { className: "list-disc space-y-2 pl-5 text-sm leading-6 text-slate-600" },
                ...
                React.createElement("li", null,
                    ...
                    " untuk simpan,",
                    " ",
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "Ctrl+Shift+S"),
                    " untuk simpan + next."),
                React.createElement("li", null,
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "Delete"),
                    " atau",
                    " ",
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "Ctrl+X"),
                    " untuk hapus box aktif."),
                React.createElement("li", null,
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "ArrowLeft"),
                    " dan",
                    " ",
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "ArrowRight"),
                ...
                React.createElement("li", null,
                    ...
                    " ",
                    "atau ",
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "Ctrl+Arrow"),
                    " menggeser 10 px."),
                React.createElement("li", null,
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "Alt+ArrowLeft"),
                    " atau",
                    " ",
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "Alt+ArrowRight"),
                ...
                React.createElement("li", null,
                    "Setelah 10 kali ",
                    React.createElement("code", { className: "rounded-sm bg-base-200 px-2 py-1 text-xs" }, "Simpan + Next"),
