    ...
    return (React.createElement(LabelerSidebarSection, { title: "Frame Aktif", eyebrow: "Workspace", description: "Navigasi frame dan jalankan aksi utama labeling tanpa meninggalkan sidebar.", badge: React.createElement(Badge, { type: interactionLocked ? "warning" : "success", className: "px-3 py-3" }, interactionLocked ? "Terkunci" : "Siap edit"), defaultOpen: true },
        React.createElement("div", { className: "space-y-4" },
            React.createElement("div", null,
                React.createElement("h2", { className: "break-all text-lg font-bold tracking-tight text-base-content" }, currentImageItem ? currentImageItem.name : "Belum ada frame"),
            ...
            React.createElement("div", { className: "grid grid-cols-5 gap-2 " },
                React.createElement(Button, { variant: "ghost", isSubmit: false, size: "xs", className: "rounded-md border border-base-300 bg-base-100", disabled: !visibleImages.length || interactionLocked, onClick: () => onNavigate(-1), toolTip: "Frame sebelumnya", toolTipPosition: "top" },
                ...
                React.createElement(Button, { variant: "ghost", isSubmit: false, size: "xs", className: "rounded-md border border-base-300 bg-base-100", disabled: !visibleImages.length || interactionLocked, onClick: () => onNavigate(1), toolTip: "Frame berikutnya", toolTipPosition: "top" },
                    React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: "1.5", stroke: "currentColor", className: "size-5" },
                        React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" }))),
                React.createElement(Button, { variant: "warning", outline: true, isSubmit: false, size: "xs", className: "rounded-md", disabled: !checkpointImageName || interactionLocked, onClick: onOpenCheckpoint, toolTip: "Lihat checkpoint", toolTipPosition: "top" },
                    React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", className: "size-5" },
                ...
                React.createElement(Button, { variant: "warning", isSubmit: false, size: "xs", className: "rounded-md", disabled: !currentImageItem?.name ||
                        currentIsCheckpoint ||
                        interactionLocked, onClick: () => onSaveCheckpoint(), toolTip: "Simpan checkpoint", toolTipPosition: "top" }, currentIsCheckpoint ? (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", className: "size-5" },
                    React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" }))) : (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: "1.5", stroke: "currentColor", className: "size-5" },
                ...
                React.createElement(Button, { variant: "warning", outline: true, isSubmit: false, size: "xs", className: "rounded-md", disabled: !hasFrames, onClick: onOpenAutolabelModal, toolTip: "Autolabel", toolTipPosition: "top" },
                    React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", className: "size-5" },
                ...
                React.createElement(Button, { variant: "primary", isSubmit: false, size: "xs", className: "rounded-md", disabled: !currentImageItem?.name || interactionLocked, onClick: onSaveLabel, toolTip: "Simpan label", toolTipPosition: "top" },
                    React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", className: "size-5" },
                ...
                React.createElement(Button, { variant: "success", isSubmit: false, size: "xs", className: "col-span-3 rounded-md", disabled: !currentImageItem?.name || interactionLocked, onClick: onSaveLabelAndNext, toolTip: "Simpan label dan frame berikutnya", toolTipPosition: "top" }, "Simpan dan lanjut")))));
}
