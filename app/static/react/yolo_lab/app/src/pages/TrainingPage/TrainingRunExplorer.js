            ...
            React.createElement("div", { className: "space-y-4" },
                React.createElement("div", { className: "flex flex-wrap items-start justify-between gap-3" },
                    React.createElement("div", null,
                        ...
                        React.createElement("h2", { className: "mt-2 text-xl font-bold tracking-tight" }, selectedRun ? selectedRun.key : "Belum ada run"),
                    ...
                    selectedRun ? (React.createElement(Badge, { type: "info", className: "px-3 py-3" }, selectedRun.totalSizeLabel)) : null),
                selectedRun ? (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("div", { className: "grid gap-3 md:grid-cols-2" },
                        React.createElement("div", { className: "rounded-sm border border-base-300 bg-base-200/40 p-3" },
                            ...
                            React.createElement("p", { className: "mt-2 break-all font-mono text-[12px] text-slate-900" }, selectedRun.config?.model || "-")),
                        React.createElement("div", { className: "rounded-sm border border-base-300 bg-base-200/40 p-3" },
                            React.createElement("p", { className: "text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500" }, "Data"),
                            React.createElement("p", { className: "mt-2 break-all font-mono text-[12px] text-slate-900" }, selectedRun.config?.data || "-"))),
                    ...
                    (selectedRun.previewArtifacts || []).length ? (React.createElement("div", { className: "grid gap-4 lg:grid-cols-3" }, selectedRun.previewArtifacts.map((artifact) => (React.createElement("article", { key: artifact.path, className: "overflow-hidden rounded-sm border border-base-300 bg-base-100 shadow-md" },
                        ...
                        React.createElement("div", { className: "p-4" },
                            ...
                            React.createElement("p", { className: "mt-1 text-[11px] text-slate-500" }, artifact.sizeLabel))))))) : (React.createElement(Alert, { type: "info", className: "rounded-sm text-sm" }, "Run ini belum memiliki artifact preview gambar.")))) : (React.createElement(Alert, { type: "info", className: "rounded-sm text-sm" }, "Belum ada detail run yang bisa ditampilkan."))))));
}
