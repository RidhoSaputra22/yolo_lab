 ...
 */
export default function Select({ label, options = [], value = "", onChange, placeholder = "Pilih...", error = null, required = false, searchable = false, searchPlaceholder = "Cari...", className = "", name, ...rest }) {
