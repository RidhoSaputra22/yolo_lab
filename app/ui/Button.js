...
export default function Button({
  ...
  const tooltipNode =
    toolTip && tooltipOpen ? (
      <span
        ...
        id={tooltipId}
        role="tooltip"
        className="pointer-events-none fixed z-[999] w-max max-w-[16rem] whitespace-normal rounded bg-slate-900 px-2 py-1 text-center text-xs font-medium leading-4 text-white shadow-lg"
        style={{
  ...
  const renderedTooltip =
    tooltipNode && globalThis.ReactDOM?.createPortal && typeof document !== "undefined"
